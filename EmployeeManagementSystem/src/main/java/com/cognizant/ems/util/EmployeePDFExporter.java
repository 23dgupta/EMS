...
public class EmployeePDFExporter {
	...
	public EmployeePDFExporter(List<Employee> listEmployees) {
	 ...
	 private void writeTableHeader(PdfPTable table) {
	        ...
	        cell.setPhrase(new Phrase("ename", font));
	         
	        table.addCell(cell);
	         
	        cell.setPhrase(new Phrase("edesignation", font));
	        table.addCell(cell);
	         
	        cell.setPhrase(new Phrase("eage", font));
	        table.addCell(cell);
	         
	        cell.setPhrase(new Phrase("email", font));
	        table.addCell(cell);
	         
	        cell.setPhrase(new Phrase("egender", font));
	        table.addCell(cell);       
	    }
	 ...
	 private void writeTableData(PdfPTable table) {
	        for (Employee emp : listEmployees) {
	            ...
	            table.addCell(emp.getEdesignation().toString());
	            table.addCell(emp.getEage().toString());
	            table.addCell(emp.getEmail());
	            table.addCell(emp.getEgender().toString());
	        }
	    }
